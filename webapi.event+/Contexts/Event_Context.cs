...
namespace webapi.event_.Contexts
{
    ...
    public class Event_Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //string de conexão SQL Database - Azuredxxdx

            optionsBuilder.UseSqlServer("Server=tcp:event-gabriel-server.database.windows.net,1433;Initial Catalog=event-gabriel-database;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30; User Id = event-gabriel-server; Pwd = Senai@134");
            base.OnConfiguring(optionsBuilder);
        }
    }
}
